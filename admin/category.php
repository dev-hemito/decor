...
<body>
            ...
            <section>
                ...
                <div id="editFormContainer">
                    ...
                    <form id="editCategoryForm">
                        ...
                        <!-- New input for category name -->
                        <input type="text" placeholder="Edit Category" name="edit-category-name" id="editCategoryName">
                        <br>
    ...
    <script>
        ...
        $(document).ready(function() {
            // Function to fetch and update the category table
            function updateCategoryTable() {
                $.ajax({
                    type: "GET",
                    url: "category/fetch.php", // Create a PHP script to fetch categories from the database
                    success: function(response) {
                        $("#categoryTableContainer table").html(response);
                    },
                    error: function() {
            ...
            $("#categoryForm").on("submit", function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        updateCategoryTable(); // Update the category table after adding a category
            ...
            $("#categoryTableContainer").on("click", ".edit-btn", function() {
                var editID = $(this).data("editid");

                // Fetch the category name corresponding to the edit button clicked
                var categoryName = $(this).closest("tr").find("td:first").text();

                // Set the category ID and name in the hidden edit form inputs
                $("#editCategoryID").val(editID);
            ...
            $("#editCategoryForm").on("submit", function(event) {
                ...
                $.ajax({
                    ...
                    error: function() {
                        $("#message").html("<p>Error updating the category.</p>");
                    }
                });
                $("#editFormContainer , .popup-overlay").hide();
            });

            $("#categoryTableContainer").on("click", ".delete-btn", function() {
            ...
            $("#confirmDeleteBtn").on("click", function() {
                ...
                $.ajax({
                    ...
                    error: function() {
                        $("#message").html("<p>Error deleting the category.</p>");
                        $("#confirmationPopup").hide();
                    }
                });
                $(".popup-overlay").hide();
